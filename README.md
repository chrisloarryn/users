...
Latest completed CI result from [`Validate Java Application #171`](https://github.com/chrisloarryn/users/actions/runs/23719303528) on `develop`:
- result: `PASS`
- tests executed: `59`
- failures: `0`
- errors: `0`
...
- Run: [`#171`](https://github.com/chrisloarryn/users/actions/runs/23719303528)
- Branch: `develop`
- Commit: [`45640bf`](https://github.com/chrisloarryn/users/commit/45640bf2c63796dc58bf721e5ab720a0fea74c42)
- Updated: March 29, 2026 21:20 UTC

| Stage | Result | Highlights |
| --- | --- | --- |
| Unit and integration | PASS | tests=59, failures=0, errors=0, skipped=0, duration=21.26s, svc=23, sec=8, repo=5, api=20, err=3, other=0 |
| Karate contracts | PASS | features=18, scenarios=101, failed=0, duration=14.12s |
| Gatling performance | PASS | requests=880, ok=880, ko=0, mean=22ms, p95=91ms, p99=101ms, throughput=51.76rps, failed assertions=0 |
